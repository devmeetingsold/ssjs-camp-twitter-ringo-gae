...
Query.prototype.filter = function (property_op, value) {
	...
	if (parts[0] == "__key__") {
	    ...
	    var filterValue;
      if (parts[1] == "IN") {
        filterValue = require('google/appengine/ext/db/properties').ListProperty.prototype.getValueForDatastore.call({defaultValue: value}, {});
      }
      else if (property.getFilterValue) { // FIXME: this is a hack, a better solution is needed.
